...
@Autonomous(name = "LuxonsBLMainAuto") //moves the wobble goal to b, shoots high goal
//@Disabled
public class LuxonsAutoBlueMain extends LinearOpMode {
    ...
    private final double powerShoot = 0.78;
    ...
    public void runOpMode() {
        ...
        run("front", 11); //moves towards location for wobble goal
        idle();
        sleep(2000);
        finishRun();
        idle();
        ...
        shiftRobot("right", 12); //positions behind the line in front of the high goal
        idle();
        sleep(1500);
        finishRun();
        idle();
        ...
        shootRing(); //1st ring shot into high goal

        shootRing(); //2nd ring shot into high goal

        shootRing(); //3rd ring shot into high goal

        shoot_motor.setPower(0);

        run("front", 8); //parks onto the line
        idle();
        sleep(1000);
        finishRun();
        idle();

...
@Autonomous(name="LuxonsBLDetWob") //detects rings and moves wobble
//@Disabled
public class LuxonsAutoVisionWobbles extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (height==2)
        {
            run("front", 55); //moves forward across over half the field
            idle();
            sleep(4000);
            finishRun();
            idle();

            spin("right", 3); //shifts to face target zone B
            idle();
            sleep(500);
            finishRun();
            idle();

            run("front", 11); //moves towards target zone B
            idle();
            sleep(2000);
            finishRun();
            idle();
            ...
            spin("left", 3); //shifts to face the ring goals
            idle();
            sleep(1000);
            finishRun();
            idle();
        ...
        {
            shiftRobot("left", 12); //shifts left to face target zone C
            idle();
            sleep(1500);
            finishRun();
            idle();

            run("front", 80); //moves forward to target zone C
            idle();
            sleep(8000);
            finishRun();
            idle();

            run("back", 34); //leaves the wobble goal
            idle();
            sleep(3000);
            finishRun();
            idle();

            shiftRobot("right", 15); //shifts right to face ring goals
            idle();
            sleep(1500);
            finishRun();
            idle();
        ...
        {
            shiftRobot("left", 12); //shifts left to face target zone A
            idle();
            sleep(1500);
            finishRun();
            idle();

            run("front", 52); //moves forward to target zone A
            idle();
            sleep(5000);
            finishRun();
            idle();

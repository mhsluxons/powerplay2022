...
//Define motor numbers below
    ...
    //Other Motors
    public DcMotor claw_motor;
    public DcMotor basket_motor;
    public DcMotor lift_motor1;
    public DcMotor lift_motor2;
    ...
    //Booleans
    public static boolean startRotationIntake = false;
    public static boolean startRotationRelease = false;
    public static boolean clawOpen = true;
    public static boolean markerDown = false;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        //Motors
        claw_motor = hardwareMap.dcMotor.get("claw_motor");
        basket_motor = hardwareMap.dcMotor.get("scissor_motor");
        lift_motor1 = hardwareMap.dcMotor.get("lift_motor1");
        lift_motor2 = hardwareMap.dcMotor.get("lift_motor2");

        //Servos
        //rightClaw = hardwareMap.servo.get("claw_servo2");
        teamMD = hardwareMap.servo.get("tmd_servo");

        //Continuous Servos
        intakeServo1 = hardwareMap.crservo.get("intake_servo1");
        //intakeServo2 = hardwareMap.crservo.get("intake_servo2");

        //Set Servo
        //rightClaw.setPosition(1.0);
        teamMD.setPosition(0);

        basket_motor.setDirection(DcMotor.Direction.FORWARD);
        ...
        claw_motor.setDirection(DcMotorSimple.Direction.REVERSE);
        claw_motor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        claw_motor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);

        lift_motor1.setDirection(DcMotorSimple.Direction.REVERSE);
        lift_motor1.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        lift_motor1.setMode(DcMotor.RunMode.RUN_USING_ENCODER);

        lift_motor2.setDirection(DcMotorSimple.Direction.FORWARD);
        lift_motor2.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        lift_motor2.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
    }
 }

...
//by Adi
//FACES BACKWARDS
@Autonomous(name = "Blue Duck Storage Park")
//@Disabled
public class LuxonsBlueDuckPark extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //moves toward duck spinner wall
        run("front", 1);
        idle();
        sleep(900);
        finishRun();

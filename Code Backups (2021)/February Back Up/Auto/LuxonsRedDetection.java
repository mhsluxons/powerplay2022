...
//by Adi
//FACES BACKWARDS
@Autonomous(name = "Initial Red Detection")
//@Disabled
public class LuxonsRedDetection extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //moves to carasouel wall
        fastshiftRobot("right", 2);
        idle();
        sleep(900);
        finishRun();
        idle();

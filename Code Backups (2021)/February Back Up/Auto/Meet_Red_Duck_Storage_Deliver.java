...
//FACES FORWARDS
@Autonomous(name = "1/8/21 Red Meet Duck Storage Deliver") //parks in the red storage area only
@Disabled
public class Meet_Red_Duck_Storage_Deliver extends LinearOpMode {

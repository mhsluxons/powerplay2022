...
//by Adi
//FACES BACKWARDS
@Autonomous(name = "Finalized Blue Hub Duck")
@Disabled
public class OLDLuxonsBlueHubDuck extends LinearOpMode {
    ...
    private double wheelPower = (powerForward[0]*0.5);
    ...
    public void runOpMode() {
        ...
        //move robot right toward shipping hub
        shiftRobot("right", 5);
        idle();
        sleep(2500);
        finishRun();
        ...
        //moves forward towards shipping hub
        run("front", 3);
        idle();
        sleep(1000);
        finishRun();
        ...
        //turns robot to face back of wall
        turnRobot("left", 2.0);
        idle();
        sleep(1000);
        finishRun();
        ...
        //move robot right to storage park
        shiftRobot("right", 3);
        idle();
        sleep(1000);
        finishRun();

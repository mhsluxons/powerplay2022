...
//by Yoonjae
//FACES BACKWARDS
@Autonomous(name = "Finalized Red Duck Hub Storage") //parks in the red storage area only
@Disabled
public class OLDLuxonsRedHubDuck extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //aligns robot to the center of field
        run("back", 1);
        idle();
        sleep(2000);
        finishRun();
        ...
        //move to align with the shipping hub
        shiftRobot("left", 2);
        idle();
        sleep(2800);
        finishRun();
        ...
        //moves forward closer to the shipping hub
        run("front", 1);
        idle();
        sleep(1350);
        finishRun();
        ...
        //move robot left close to the wall
        shiftRobot("right", 1);
        idle();
        sleep(2500);
        finishRun();

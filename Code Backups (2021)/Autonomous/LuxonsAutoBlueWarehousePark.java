...
//FACES SIDEWAYS, FORWARDS
@Autonomous(name = "LB Park Warehouse") //parks in the blue warehouse area only
//@Disabled
public class LuxonsAutoBlueWarehousePark extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //shifts over towards the barcode line
        shiftRobot("right", 15);
        idle();
        sleep(3000);
        finishRun();

...
//FACES BACKWARDS
@Autonomous(name = "LR Storage Deliver") //parks in the red storage area and delivers block
//@Disabled
public class LuxonsAutoRedStorageDeliver extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //moves more into the storage parking area, pushes block in
        run("back", 5);
        idle();
        sleep(1500);
        finishRun();

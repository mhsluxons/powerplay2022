...
//FACES FORWARDS
@Autonomous(name = "RB Duck Storage") //parks in the blue storage area and delivers duck
//@Disabled
public class LuxonsAutoBlueDuckStorage extends LinearOpMode {
    ...
    //private final double duckSpinner = 0.15;
    ...
    public void runOpMode() {
        ...
        //move robot right towards duck carousel
        shiftRobot("right", 8);
        idle();
        sleep(2000);
        finishRun();
        ...
        //moves more into the storage parking area
        run("forward", 5);
        idle();
        sleep(1500);
        finishRun();

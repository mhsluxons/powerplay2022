...
//FACES FORWARDS
@Autonomous(name = "RB Duck Warehouse") //parks in the blue warehouse area and delivers duck
//@Disabled
public class LuxonsAutoBlueDuckWarehouse extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //robot moves towards the warehouse area
        shiftRobot("left", 30);
        idle();
        sleep(3000);
        finishRun();
        ...
        //robot moves over front of the barcode
        run("front", 5);
        idle();
        sleep(1500);
        finishRun();

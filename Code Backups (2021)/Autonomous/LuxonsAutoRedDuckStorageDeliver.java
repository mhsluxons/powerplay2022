...
//FACES BACKWARDS
@Autonomous(name = "LR Duck Storage Deliver") //parks in the red storage area and delivers block
//@Disabled
public class LuxonsAutoRedDuckStorageDeliver extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        turnRobot("right", 10); //turns right to face the back of the robot towards the storage unit
        idle();
        sleep(2000);
        finishRun();
        idle();
